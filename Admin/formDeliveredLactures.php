...
?>
<html>
<title> Delivered Lactures </title>
<body>
<section id="main" class="column">
<h4 class="alert_info">Welcome To Add Delivered Lactures</h4>
<article class="module track_full">
<header><h3 class="tabs_involved">Add Delivered Lactures</h3></header>
<div id="tab1" class="tab_content">
<table cellpadding="5" cellspacing="5">
<form action="deliveredLactures.php" method="post">
		              <input type="hidden" id="employeeId" name="employeeId"value="<?php echo $employee_id ?>"/>
 	  <tr><td> Lacture Subject</td><td><input type="text" id="txtlacture_subject" name="txtlacture_subject" /></td></tr>
