...
$query="select * from login l,employee e where l.employee_id=e.employee_id and l.login_id='".$login_id."'";
$query_result=mysql_query($query);
if($result=mysql_fetch_array($query_result))
{
	$id=$result['employee_id'];
	//Personal Information employee table query
	$temp="select d.department_name,i.institute_name from department d,employee e,institute i where i.institute_id=d.institute_id and e.department_id=d.department_id and e.employee_id=".$id;
	$temp=mysql_query($temp);
	$temp=mysql_fetch_array($temp);
	$department=$temp['department_name'];
	$institute=$temp['institute_name'];
	
	echo "<h4 class='alert_info'>Welcome To Department Of " .$institute .", ".$department."</h4>";
	...
	echo"<thead><tr><th>Filed</th><th>Information</th></tr></thead>";
	echo"<tbody> ";
	...
	$query_result=mysql_query($query);
	echo "<header><h3 class='tabs_involved'>Contact Information</h3></header>";
	echo "<div id='tab1' class='tab_content'>";
	echo "<table class='tablesorter' cellspacing='0'> ";
	echo"<thead><tr><th>Filed</th><th>Information</th></tr></thead>";
	echo"<tbody> ";
 ...
 from employee_language el,language l where el.language_id=l.language_id and employee_id=".$id;
	...
	echo "<header><div id='lInterest'><h3 class='tabs_involved'>Employee Interest</h3></div></header>";
	echo "<div id='tab1' class='tab_content'>";
	...
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td><a href='updateInterest.php?interestId=".$result['employee_interest_id']."'>Edit</a>  ";
		echo "<a href='deleteInterest.php?interestId=".$result['employee_interest_id']."'>Delete</a></a>";
		echo "<tr>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['interest_type']."</td>";
		echo "<td><a href='updateInterest.php?interestId=".$result['employee_interest_id']."'>Edit</a>  ";
		echo "<a href='deleteInterest.php?interestId=".$result['employee_interest_id']."'>Delete</a></td>";
		echo "</tr>";
		$no++;
	}
		echo "</table></div>";
	...
	echo "<header><div id='lQualification'><h3 class='tabs_involved'>Qualification</h3></div></header>";
	...
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td><a href='editQualification.php?employee_qualification_id=".$result['employee_qualification_id']."'>Edit</a>";
		echo "<a href='deleteQualification.php?employee_qualification_id=".$result['employee_qualification_id']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
	...
	echo "<header><div id='lExperience'><h3 class='tabs_involved'>employee experience</h3></div></header>";
	...
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td><a href='updateExperience.php?employee_experience_id=".$result['employee_experience_id']."'> Edit</a> ";
		echo "<a href='deleteExperience.php?employee_experience_id=".$result['employee_experience_id']."'>Delete</a></td>";
		echo "<tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
	...
	tp.event_type_id=epp.event_type_id and e.employee_id=".$id." order by epp.date_of_publication desc";
	//echo $query;
	$query_result=mysql_query($query);
	if($result=mysql_fetch_array($query_result))
	{
		...
		//echo "<td>Edit  ";
		echo "<td><a href='deletePublishPaper.php?employee_publication_id=".$result['employee_publication_id']."'>Delete</a></td>";
		echo "<tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
	...
	where rp.employee_id=e.employee_id and rp.employee_id=".$id." order by rp.submitted_on_date desc";
	$query_result=mysql_query($query);
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['API_score']."</td>";
		echo "<td><a href='updateResearchProject.php?research_project_id=".$result['research_project_id']."'>Edit</a>  ";
		echo "<a href='deleteResearchProject.php?research_project_id=".$result['research_project_id']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
	...
	where e.employee_id=epp.employee_id and epp.event_level_id=el.event_level_id and e.employee_id=".$id." order by epp.date desc";
	$query_result=mysql_query($query);
	if($result=mysql_fetch_array($query_result))
	{
	   ...
	   echo "<div id='tab1' class='tab_content'>";
		...
		echo "<td>".$result['API_score']."</td>";
		echo "<td><a href='updatePresentedPaper.php?employee_presented_paper_id=".$result['employee_presented_paper_id']."'>Edit</a>  ";
		echo "<a href='deletePresentedPaper.php?employee_presented_paper_id=".$result['employee_presented_paper_id']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['API_score']."</td>";
		echo "<td><a href='deletePresentedPaper.php?employee_presented_paper_id=".$result['employee_presented_paper_id']."'>Edit</a>  ";
		echo "<a href='deletePresentedPaper.php?employee_presented_paper_id=".$result['employee_presented_paper_id']."'>Delete</a></td>";
		echo "</tr>";
		$no++;
	}
	...
	where ep.employee_id=e.employee_id and e.employee_id=".$id." order by ep.date_of_publication desc";
	$query_result=mysql_query($query);
	if($result=mysql_fetch_array($query_result))
	{
	echo "<header><div id='lPulishedBook'><h3 class='tabs_involved'>Published Book</h3></div></header>";
	echo "<div id='tab1' class='tab_content'>";
	echo "<table id='tPulishedBook' class='tablesorter' cellspacing='0'> ";
		...
		echo "<td><a href='updatePublishBook.php?employee_published_books_id=".$result['employee_published_books_id']."'>Edit</a>  ";
		echo "<a href='deletePublishBook.php?employee_published_books_id=".$result['employee_published_books_id']."'>Delete</a></td>";
		echo "</tr>";
	while($result=mysql_fetch_array($query_result))
	{
		echo "<tr>";
	...
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['API_score']."</td>";
		//echo "<td>Edit  ";
		echo "<td><a href='deleteParticipation.php?employee_participation_id=".$result['employee_participation_id']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
	...
	where ma.employee_id=e.employee_id and e.employee_id=".$id." order by ma.date desc";
	$query_result=mysql_query($query);
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['organized_by']."</td>";
		//echo "<td>Edit  ";
		echo "<td><a href='deleteMeetingAttend.php?meeting_attended_id=".$result['meeting_attended_id']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
	...
	dl.event_level_id=el.event_level_id and dl.employee_id=".$id." order by dl.date desc";
	$query_result=mysql_query($query);
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['event_name']."</td>";
		echo "<td>".$result['date']."(minutes)</td>";
		echo "<td>".$result['organized_by']."</td>";
		echo "<td>".$result['sponsored_by']."</td>";
		echo "<td>".$result['event_level']."</td>";
		...
		echo "<td>".$result['API_score']."</td>";
		//echo "<td>Edit  ";
		echo "<td><a href='deleteDeliveredLactures.php?delivered_lectures_id=".$result['delivered_lectures_id']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
	...
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['sponsored_by']."</td>";
		echo "<td>".$result['location']."</td>";
		echo "<td><a href='updateAward.php?award_id=".$result['award_id']."'>Edit</a>  ";
		echo "<a href='deleteAward.php?award_id=".$result['award_id']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
	...
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['location']."</td>";
		echo "<td><a href='updateExaminationDuties.php?examination_duties_id=".$result['examination_duties_id']."'>Edit</a>  ";
		echo "<a href='deleteExaminationDuties.php?examination_duties_id=".$result['examination_duties_id']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
	...
	rp.type_of_nature_of_work_id=nw.type_of_nature_of_work_id and e.employee_id=".$id." order by rp.date desc";
	$query_result=mysql_query($query);
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['location']."</td>";
		echo "<td>".$result['date']."</td>";
		echo "<td><a href='updateInviteasResearchPerson.php?invited_as_resource_person=".$result['invited_as_resource_person']."'>Edit</a>  ";
		echo "<a href='deleteInviteasResearchPerson.php?invited_as_resource_person=".$result['invited_as_resource_person']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
	...
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['type_of_nature_of_work']."</td>";
		echo "<td>".$result['from_date']." to ".$result['to_date']."</td>";
		echo "<td><a href='updateEmployeeMembership.php?employee_membership_id=".$result['employee_membership_id']."'>Edit</a>  ";
		echo "<a href='deleteMembership.php?employee_membership_id=".$result['employee_membership_id']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['from_date']." to ".$result['to_date']."</td>";
		echo "<td><a href='updateEmployeeMembership.php?employee_membership_id=".$result['employee_membership_id']."'>Edit</a>  ";
		echo "<a href='updateEmployeeMembership.php?employee_membership_id=".$result['employee_membership_id']."'>Delete</a></td>";
		echo "</tr>";
		$no++;
	}
		echo "</table></div>";
	...
	if($result=mysql_fetch_array($query_result))
	{
		...
		echo "<td>".$result['type_of_nature_of_work']."</td>";
		echo "<td>".$result['from_date']." to ".$result['to_date']."</td>";
		echo "<td><a href='upadteOtherActivity.php?activity_id=".$result['activity_id']."'>Edit</a>  ";
		echo "<a href='deleteOtherActivity.php?activity_id=".$result['activity_id']."'>Delete</a></td>";
		echo "</tr>";
		$no=2;
	while($result=mysql_fetch_array($query_result))
	{
